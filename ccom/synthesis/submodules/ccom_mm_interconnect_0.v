...
module ccom_mm_interconnect_0 (
	...
	wire    [8:0] cmd_mux_001_src_channel;                                                                // cmd_mux_001:src_channel -> intel_niosv_m_0_dm_agent_agent:cp_channel
	...
	wire    [8:0] cmd_mux_002_src_channel;                                                                // cmd_mux_002:src_channel -> onchip_memory2_0_s1_agent:cp_channel
	...
	wire    [8:0] cmd_mux_003_src_channel;                                                                // cmd_mux_003:src_channel -> pio_0_s1_agent:cp_channel
	...
	wire    [8:0] cmd_mux_004_src_channel;                                                                // cmd_mux_004:src_channel -> pio_1_s1_agent:cp_channel
	...
	wire    [8:0] cmd_mux_005_src_channel;                                                                // cmd_mux_005:src_channel -> pio_q0_s1_agent:cp_channel
	...
	wire    [8:0] cmd_mux_006_src_channel;                                                                // cmd_mux_006:src_channel -> pio_q2_s1_agent:cp_channel
	...
	wire    [8:0] cmd_mux_007_src_channel;                                                                // cmd_mux_007:src_channel -> pio_q3_s1_agent:cp_channel
	...
	wire          cmd_mux_008_src_valid;                                                                  // cmd_mux_008:src_valid -> intel_niosv_m_0_timer_sw_agent_agent:cp_valid
	wire  [107:0] cmd_mux_008_src_data;                                                                   // cmd_mux_008:src_data -> intel_niosv_m_0_timer_sw_agent_agent:cp_data
	wire          cmd_mux_008_src_ready;                                                                  // intel_niosv_m_0_timer_sw_agent_agent:cp_ready -> cmd_mux_008:src_ready
	wire    [8:0] cmd_mux_008_src_channel;                                                                // cmd_mux_008:src_channel -> intel_niosv_m_0_timer_sw_agent_agent:cp_channel
	wire          cmd_mux_008_src_startofpacket;                                                          // cmd_mux_008:src_startofpacket -> intel_niosv_m_0_timer_sw_agent_agent:cp_startofpacket
	wire          cmd_mux_008_src_endofpacket;                                                            // cmd_mux_008:src_endofpacket -> intel_niosv_m_0_timer_sw_agent_agent:cp_endofpacket
	...
	wire  [107:0] intel_niosv_m_0_timer_sw_agent_agent_rp_data;                                           // intel_niosv_m_0_timer_sw_agent_agent:rp_data -> router_010:sink_data
	...
	wire    [8:0] router_src_channel;                                                                     // router:src_channel -> intel_niosv_m_0_data_manager_limiter:cmd_sink_channel
	...
	wire    [8:0] intel_niosv_m_0_data_manager_limiter_cmd_src_channel;                                   // intel_niosv_m_0_data_manager_limiter:cmd_src_channel -> cmd_demux:sink_channel
	...
	wire    [8:0] rsp_mux_src_channel;                                                                    // rsp_mux:src_channel -> intel_niosv_m_0_data_manager_limiter:rsp_sink_channel
	...
	wire    [8:0] intel_niosv_m_0_data_manager_limiter_rsp_src_channel;                                   // intel_niosv_m_0_data_manager_limiter:rsp_src_channel -> intel_niosv_m_0_data_manager_agent:rp_channel
	...
	wire    [8:0] router_001_src_channel;                                                                 // router_001:src_channel -> intel_niosv_m_0_instruction_manager_limiter:cmd_sink_channel
	...
	wire    [8:0] intel_niosv_m_0_instruction_manager_limiter_cmd_src_channel;                            // intel_niosv_m_0_instruction_manager_limiter:cmd_src_channel -> cmd_demux_001:sink_channel
	...
	wire    [8:0] rsp_mux_001_src_channel;                                                                // rsp_mux_001:src_channel -> intel_niosv_m_0_instruction_manager_limiter:rsp_sink_channel
	...
	wire    [8:0] intel_niosv_m_0_instruction_manager_limiter_rsp_src_channel;                            // intel_niosv_m_0_instruction_manager_limiter:rsp_src_channel -> intel_niosv_m_0_instruction_manager_agent:rp_channel
	...
	wire    [8:0] cmd_demux_001_src0_channel;                                                             // cmd_demux_001:src0_channel -> cmd_mux_001:sink1_channel
	...
	wire    [8:0] cmd_demux_001_src1_channel;                                                             // cmd_demux_001:src1_channel -> cmd_mux_002:sink1_channel
	...
	wire    [8:0] rsp_demux_001_src1_channel;                                                             // rsp_demux_001:src1_channel -> rsp_mux_001:sink0_channel
	...
	wire    [8:0] rsp_demux_002_src1_channel;                                                             // rsp_demux_002:src1_channel -> rsp_mux_001:sink1_channel
	...
	wire    [8:0] intel_niosv_m_0_data_manager_limiter_cmd_valid_data;                                    // intel_niosv_m_0_data_manager_limiter:cmd_src_valid -> cmd_demux:sink_valid
	wire    [8:0] intel_niosv_m_0_instruction_manager_limiter_cmd_valid_data;                             // intel_niosv_m_0_instruction_manager_limiter:cmd_src_valid -> cmd_demux_001:sink_valid
	...
	wire          intel_niosv_m_0_timer_sw_agent_agent_rdata_fifo_out_valid;                              // intel_niosv_m_0_timer_sw_agent_agent_rdata_fifo:out_valid -> avalon_st_adapter_008:in_0_valid
	wire   [33:0] intel_niosv_m_0_timer_sw_agent_agent_rdata_fifo_out_data;                               // intel_niosv_m_0_timer_sw_agent_agent_rdata_fifo:out_data -> avalon_st_adapter_008:in_0_data
	wire          intel_niosv_m_0_timer_sw_agent_agent_rdata_fifo_out_ready;                              // avalon_st_adapter_008:in_0_ready -> intel_niosv_m_0_timer_sw_agent_agent_rdata_fifo:out_ready
	wire          avalon_st_adapter_008_out_0_valid;                                                      // avalon_st_adapter_008:out_0_valid -> intel_niosv_m_0_timer_sw_agent_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_008_out_0_data;                                                       // avalon_st_adapter_008:out_0_data -> intel_niosv_m_0_timer_sw_agent_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_008_out_0_ready;                                                      // intel_niosv_m_0_timer_sw_agent_agent:rdata_fifo_sink_ready -> avalon_st_adapter_008:out_0_ready
	wire    [0:0] avalon_st_adapter_008_out_0_error;                                                      // avalon_st_adapter_008:out_0_error -> intel_niosv_m_0_timer_sw_agent_agent:rdata_fifo_sink_error
